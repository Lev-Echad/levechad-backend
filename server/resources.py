...
class VolunteerResource(resources.ModelResource):
    ...
    keep_mandatory_worker_children = Field(
        attribute='keep_mandatory_worker_children',
        column_name='מעוניין לסייע לילדי עובדים חיוניים?',
        default=''
    )
    ...
    class Meta:
        ...
        fields = (
            ...
            'address',
            'available_saturday',
            'keep_mandatory_worker_children',
            'guiding',
            'notes',
            'moving_way',
            'hearing_way',
