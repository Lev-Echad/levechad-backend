...
from django.core.validators import MinValueValidator, MaxValueValidator, DecimalValidator, RegexValidator
...
class Volunteer(Timestampable):
    ...
    wanted_assignments = MultiSelectField(choices=TYPES, default=1)
...
class ParentalConsent(models.Model):
    ...
    parent_id = models.CharField(max_length=9, validators=[RegexValidator(r'^[0-9]{9}$')])
