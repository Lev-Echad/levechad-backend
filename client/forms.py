...
from client.models import Volunteer, Language, DEFAULT_MAX_FIELD_LENGTH, ID_LENGTH
...
class VolunteerForm(forms.Form):
    ...
    date_of_birth = forms.DateField(input_formats=['%Y-%m-%d', '%d/%m/%Y', '%d/%m/%y', '%d.%m.%Y', '%d.%m.%y'], required=True)
